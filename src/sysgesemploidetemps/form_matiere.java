 ...
 * @author kaido
 */
public class form_matiere extends javax.swing.JFrame {

    public form_matiere() {
        initComponents();
        try {
            matiere.show(jTable1);
        } catch (SQLException ex) {
            Logger.getLogger(form_matiere.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /*try{
            coeff = Integer.parseInt(coeff_m.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(nom.isEmpty()){
            ...
            if(m.delete()){
                JOptionPane.showMessageDialog(rootPane,"Matière supprimé","succès",JOptionPane.INFORMATION_MESSAGE);            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_matiere.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_matiere().setVisible(true);
            }
        });
    }
